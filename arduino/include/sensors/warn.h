...
#define _LED_WARN_CODE_VARIANT_1(color) \
  LED_BLINK_ONCE_LONG(color), \
  LED_BLINK_ONCE_LONG(color), \
  LED_BLINK_ONCE_LONG(color), \
  LED_BLINK_LAST_LONG(color)

#define _LED_WARN_CODE_VARIANT_2(color) \
  LED_BLINK_ONCE_SHORT(color), \
  LED_BLINK_ONCE_SHORT(color), \
  LED_BLINK_ONCE_SHORT(color), \
  LED_BLINK_ONCE_LONG(color), \
  LED_BLINK_ONCE_LONG(color), \
