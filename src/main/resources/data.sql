...
INSERT INTO access_point (AP_NAME, LAST_UPDATE, SERVER_ADDRESS, CLIENT_ADDRESS, AP_STATUS) VALUES
    ('AP 1', '2016-01-01 00:00:00', '192.168.0.101', '192.168.0.102', 'OFFLINE')
...
INSERT INTO sensor_values (VALUES_ID, AIR_PRESSURE, AIR_QUALITY, HUMIDITY, LIGHT_INTENSITY, SOIL_MOISTURE, TEMPERATURE) VALUES
    ( '1', '9000200', '20', '20', '20', '20', '20'),
    ( '2', '8100000',  '0',  '0',  '0',  '0',  '0'),
    ( '3', '9200300', '30', '30', '30', '30', '30'),
    ( '4', '8300155', '15',  '4', '29', '24', '15'),
    ( '5', '9400138', '13', '16', '18',  '6',  '8'),
    ( '6', '8500258', '25', '22', '20', '17',  '8'),
    ( '7', '9600292', '29', '29', '11',  '9',  '2'),
    ( '8', '8700277', '27',  '9', '13', '12', '17'),
    ( '9', '9800303', '30', '13',  '9', '20', '13'),
    ('10', '8900038',  '3',  '1', '10', '29', '28'),
    ('11', '9000200', '20',  '7', '25', '23', '20'),
    ('12', '8100216', '21', '17', '23', '27', '16'),
    ('13', '9200196', '19', '15', '18', '11',  '6')
...
INSERT INTO sensor_station (SS_ID, SS_STATUS, AGGREGATION_PERIOD, AP_NAME, UPPER_VALUES_ID, LOWER_VALUES_ID) VALUES
    ('1', 'OFFLINE', '30', 'AP 1', '1', '2'),
    ('2', 'OFFLINE', '60', 'AP 1', '3', '2')
