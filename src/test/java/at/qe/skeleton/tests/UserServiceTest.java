...
public class UserServiceTest {
    ...
    public void testCreateUser() {
        ...
        Assertions.assertTrue(freshlyCreatedUser.getRoles().contains(UserRole.GARDENER), "User \"" + username + "\" does not have role MANAGER");
        Assertions.assertTrue(freshlyCreatedUser.getRoles().contains(UserRole.USER), "User \"" + username + "\" does not have role EMPLOYEE");
